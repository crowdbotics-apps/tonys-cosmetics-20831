"""tonys_cosmetics_20831 URL Configuration
...
admin.site.site_header = "Tonys cosmetics"
admin.site.site_title = "Tonys cosmetics Admin Portal"
admin.site.index_title = "Tonys cosmetics Admin"

# swagger
api_info = openapi.Info(
    title="Tonys cosmetics API",
    default_version="v1",
    description="API documentation for Tonys cosmetics App",
)
